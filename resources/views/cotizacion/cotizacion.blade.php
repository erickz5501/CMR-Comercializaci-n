        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-header" style="padding-bottom: 10px !important;">
                    <div class="row align-middle">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-2" style="padding-bottom: 10px !important;">
                            <select  name="filtro_estado" id="filtro_estado" class="form-control" onchange="lista_tabla_cotizaciones(1);" style="color: black !important; " data-minimum-results-for-search="Infinity">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-10 text-right">
                            <button onclick="limpiar_cotizacion();" type="button"  data-toggle="modal" data-target="#modal_cotizacion" class="btn btn-outline-primary px-3 py-2" style="margin: 0px 0px 10px !important;" >
                ...
                <div class="card-body" style="padding-top: 10px !important;" >
                    <div class="row" >
                        <div class="col-sm-12 col-md-4 col-lg-3 col-xl-3 " >
                            <label class="media align-items-center">
                                ...
                                <select name="filtro_cant" id="filtro_cant" onchange="lista_tabla_cotizaciones(1);" aria-controls="datatable-basic" class="form-control form-control-sm"  style="color: black !important; font-weight: bold !important; display: inline-block;" >
                    ...
                    <div  id="lista_tabla_cotizaciones" >
                    </div>
                </div>
            </div>
        </div>
