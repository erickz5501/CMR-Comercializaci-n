            ...
            @if (count($modulos) > 0)
                @foreach ($modulos as $count => $modulo)
                    <tr>
                        ...
                        <td class="align-middle">{!! Str::limit(strip_tags($modulo->caracteristicas), 30, ' ...'); !!}</td>
...
<div class="card-footer py-4">
    <div class="row"  >
        <div class="d-none {{ $modulos->total() / $modulos->perPage() > 5 ? 'd-md-none d-lg-none d-xl-none' : ' d-md-block' }} col-xs-12 col-ms-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
            Mostrando {{ count($modulos) }} de {{ $modulos->total() }} registros.
        </div>
        <div class=" col-xs-12 col-sm-12 {{ $modulos->total() / $modulos->perPage() > 10 ? 'col-md-12 col-lg-12 col-xl-12' : 'col-md-6 col-lg-6 col-xl-6' }} " style="overflow-x: auto;">
