...
@section('content')
    ...
    <!-- :::: MODAL DETALLE CLIENTE INTERESADO:::: -->
    <div class="modal fade" id="modal_detalle_cliente_interesado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document" id="detalle_cliente_interesado">
            <!-- Contenido del modal /  -->
        </div>
    </div>
    <!-- FIN-MODAL -->
