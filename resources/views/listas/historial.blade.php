                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="persona_contacto_input" name="persona_contacto_input" placeholder="Nombres" required>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="modulos-input">Modulos</label>
                                                <select name="select_modal_modulos" id="select_modal_modulos" class="form-control multi_select" data-toggle="select" required>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="select_modal_medios" name="select_modal_medios" data-toggle="select" required>
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="llamadaDetTextarea" name="llamadaDetTextarea" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="eventosSelect">Eventos</label>
                                                <select class="form-control" id="select_modal_eventos" name="select_modal_eventos" data-toggle="select" required>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="date" value="2018-11-23" id="example_date_input" name="example_date_input" required>
                                            </div>                                    
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="eventoTextarea">Detalle evento</label>
                                                <textarea class="form-control" id="eventoTextarea" name="eventoTextarea" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label for="personalInput">Personal</label>
                                                <select class="form-control" id="select_modal_personal" name="select_modal_personal" data-toggle="select" required>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="calificacionSelect" name="calificacionSelect">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="solucionInput" name="solucionInput" placeholder="Solucion">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="observacionesTextarea" name="observacionesTextarea" rows="3"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="conclusionesTextarea">Conclusiones</label>
                                                <textarea class="form-control" id="conclusionesTextarea" name="conclusionesTextarea" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
