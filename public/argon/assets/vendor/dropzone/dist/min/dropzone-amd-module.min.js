    ...
    var g = { exports: {} },
        ...
        j = (function (a) {
            function g(a, c) {
                ...
                return (
                    e.options.acceptedMimeTypes && ((e.options.acceptedFiles = e.options.acceptedMimeTypes), delete e.options.acceptedMimeTypes),
                            ...
                            (this.prototype.Emitter = i),
                                ...
                                (this.prototype.defaultOptions = {
                                    ...
                                    fallback: function () {
                                        ...
                                        return (
                                            h && (null != h.textContent ? (h.textContent = this.options.dictFallbackMessage) : null != h.innerText && (h.innerText = this.options.dictFallbackMessage)),
                                    ...
                                    addedfile: function (a) {
                                        ...
                                        if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                            ...
                                            this.options.addRemoveLinks &&
                                                ((a._removeLink = g.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>")), a.previewElement.appendChild(a._removeLink));
                                            for (
                                                var l = function (c) {
                                                        return (
                                                            c.preventDefault(),
                            ...
                            value: function () {
                                ...
                                if (
                                    ...
                                    this.element.classList.contains("dropzone") &&
                                        ...
                                        this.element.appendChild(g.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")),
                                    ...
                                    !(function b() {
                                        return (
                                            ...
                                            g.getElement(a.options.hiddenInputContainer, "hiddenInputContainer").appendChild(a.hiddenFileInput),
                            ...
                            value: function () {
                                ...
                                return (
                                    "FORM" !== this.element.tagName
                                        ? ((b = g.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')), b.appendChild(d))
                            ...
                            value: function (a) {
                                ...
                                this._transformFiles(a, function (c) {
                                    if (a[0].upload.chunked) {
                                        ...
                                        var h = function () {
                                            ...
                                            if (!(c >= d.upload.totalChunkCount)) {
                                                ...
                                                var h = c * b.options.chunkSize,
                                                    ...
                                                    j = { name: b._getParamName(0), data: e.webkitSlice ? e.webkitSlice(h, i) : e.slice(h, i), filename: d.upload.filename, chunkIndex: c };
                                                (d.upload.chunks[c] = { file: d, index: c, dataBlock: j, status: g.UPLOADING, progress: 0, retries: 0 }), b._uploadData(a, [j]);
                                            }
                                        };
                                        if (
                                        ...
                                        for (var j = [], k = 0; k < a.length; k++) j[k] = { name: b._getParamName(k), data: c[k], filename: a[k].upload.filename };
                                        b._uploadData(a, j);
                                    }
                                });
                            },
                        ...
                        },
                        {
                            ...
                            value: function (a, b, c) {
                                ...
                                if (a[0].status !== g.CANCELED && 4 === b.readyState) {
                                    if ("arraybuffer" !== b.responseType && "blob" !== b.responseType && ((d = b.responseText), b.getResponseHeader("content-type") && ~b.getResponseHeader("content-type").indexOf("application/json")))
                                        try {
                                            d = JSON.parse(d);
                                        } catch (a) {
